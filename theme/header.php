...
<head>
    ...
    <meta name="description" content="<?php echo get_post_meta(get_the_ID(), 'baluchon-description', true) ? get_post_meta(get_the_ID(), 'baluchon-description', true) : 'Entreprise de carrelage sur Toulouse.'; ?>">
	...
	<script src="<?= get_template_directory_uri();?>/utils/fix/jquery-ui-1.13.2.custom/external/jquery/jquery.js"> </script>
	...
	<script src="<?= get_template_directory_uri();?>/utils/fix/jquery-ui-1.13.2.custom/jquery-ui.min.js"> </script>
	...
	<link rel="stylesheet" href="<?= get_template_directory_uri();?>/utils/fix/jquery-ui-1.13.2.custom/jquery-ui.min.css">
</head>
...
<header>
    <a class="heading-logo" href="/" aria-label="go-back-to-homepage">
        ...
        $image = wp_get_attachment_image_src( $custom_logo_id , 'full' );
         ?>
         <img  src="<?php echo $image[0]; ?>" width="70px" height="70px" alt="Yellow logo of the test site">
    </a>
